            ...
            <span key={crumb.label} className="flex items-center gap-2">
              ...
              {crumb.path && !isLast ? (
                <button
                  ...
                  className="text-lg font-bold text-slate-400 hover:text-slate-700 transition-colors"
                >
                  {crumb.label}
                </button>
              ) : (
                <span className="text-lg font-bold text-slate-800">{crumb.label}</span>
              )}
            </span>
          )
        })}
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 text-slate-500">
          <div className="flex items-center gap-1.5 bg-slate-100 px-3 py-1.5 rounded-full">
            ...
            <span className="text-xs font-bold text-slate-700">1,000</span>
          </div>
          <div className="flex items-center gap-1.5 bg-slate-100 px-3 py-1.5 rounded-full">
        ...
        <div className="relative cursor-pointer">
          <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-[10px] text-white flex items-center justify-center rounded-full border-2 border-white font-bold">4</span>
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-slate-500">Directeur Commercial</p>
          </div>
